...
<body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/Logo-dark-gesits.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <main>
                        ...
                        <div class="row justify-content-between align-items-center">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 d-none d-sm-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="assets/img/The Future.png" alt="" class=" heartbeat" style="margin: 0 auto; max-width:1100px;">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- slider Area End-->
        <!-- ? New Product Start -->
        <section class="new-product-area select-padding30">
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="assets/img/Lokasi-Kami-800x600.jpg" alt="">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="assets/img/thumbs-test-800x600-1.jpg" alt="">
                            </div>
                            <div class="product-caption">
                                <h3>
                                    <a href="contact.php">Spesifikasi</a>
                                </h3>
                                <span> Pelajari Teknologi Gesits </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="assets/img/bg-thumbs-spek-800x600.jpg" alt="">
                            </div>
                            <div class="product-caption">
                                <h3>
                                    <a href="#">Daftar Test Drive</a>
                                </h3>
                                <span> Uji coba motor listrik gesits. </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="assets/img/3d-Logo-Sign-Mockup-1-scaled-800x600.jpg" alt="">
                            </div>
                            <div class="product-caption">
                                <h3>
                                    <a href="product_details.php">Pesan Sekarang</a>
                                </h3>
                                <span> Tentukan pilihan warnamu. </span>
                            </div>
                        </div>
                    </div>
                </div>
